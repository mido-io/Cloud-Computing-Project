...
async function main() {
  const uriAuth = 'mongodb://auth_db:27017/auth_db?authSource=admin';
  const uriRest = 'mongodb://restaurant_db:27017/restaurant_db?authSource=admin';
  ...
  try {
    ...
    console.log("Auth DB error: " + e.message);
  }
  ...
  try {
    ...
    console.log("Restaurant DB error: " + e.message);
  }
}
main();
